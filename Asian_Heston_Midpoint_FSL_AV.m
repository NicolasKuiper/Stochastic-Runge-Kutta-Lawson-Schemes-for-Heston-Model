...
[~,S1,~] = MidpointFSLVectorized(X0,A,g0,B,g,tspan,h,dW1,g0Jac,gJac,Bexp);    % returns price and volatility paths
[~,S2,~] = MidpointFSLVectorized(X0,A,g0,B,g,tspan,h,dW2,g0Jac,gJac,Bexp);    % returns price and volatility paths
S1 = real(S1);
S2 = real(S2);
